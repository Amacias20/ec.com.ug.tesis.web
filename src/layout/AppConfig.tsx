import type { AppConfigProps, ColorScheme, LayoutConfig, LayoutState } from '../types/index';
...
const AppConfig = (props: AppConfigProps) => {
    ...
    useEffect(() => {
        if (isSlim() || isSlimPlus() || isHorizontal()) {
            setLayoutState((prevState: LayoutState) => ({ ...prevState, resetMenu: true }));
        }
    ...
    const onChangeMenuTheme = (name: string) => {
        setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, menuTheme: name }));
    };
    ...
    const _changeTheme = (componentTheme: string) => {
        changeTheme?.(layoutConfig.componentTheme, componentTheme, 'theme-link', () => {
            setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, componentTheme }));
        });
    };
    const onTopbarChangeTheme = (name: string) => {
        setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, topbarTheme: name }));
    };
